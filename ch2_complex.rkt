...
(define (install-polar-package)
 ...
 ;;; commented out because same methods exist already
 ...
 (define (install-scheme-number-package)
   ...
   (put 'make 'scheme-number
        (lambda (x) (tag x)))
   '(DONE INITIALIZED SCHEME NUMBER PACKAGE))
 ...
 (define (install-rational-package)
   ...
   '(DONE INITIALIZED RATIONAL PACKAGE))
...
(define (install-complex-package)
  ...
  '(DONE INITIALIZED COMPLEX PACKAGE))
